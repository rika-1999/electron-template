...
- Locate existing docs: `docs/`, `README.md`, existing AGENTS.md/CLAUDE.md
...
4. If CLAUDE.md exists with content → migrate to AGENTS.md, convert CLAUDE.md to link file:
